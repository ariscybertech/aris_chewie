...
class Chewie extends StatefulWidget {
  Chewie({Key key, this.controller, this.beforeFullScreen, this.afterFullScreen})
...
class ChewieState extends State<Chewie> {
  ...
  Widget build(BuildContext context) {
    return _ChewieControllerProvider(controller: widget.controller, child: PlayerWithControls());
  }

  Widget _buildFullScreenVideo(
      BuildContext context, Animation<double> animation, _ChewieControllerProvider controllerProvider) {
    return Scaffold(
